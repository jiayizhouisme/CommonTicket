        ...
        if (that.articleTypeList.length <= 0) {
            layui.use(['coreHelper'],
                function () {
                    ...
                    var id = test.split("?id=")[1];
                    if (id) {
                        coreHelper.Post("shopserver/api/CoreCmsPages/GetArticleTypes",
                            { id: id },
                            function (e) {
                                if (e.code === 0) {
                                    ...
                                    upload() {
                                        return new Promise((resolve, reject) => {
                                            ...
                                            this.loader.file.then(res => {
                                                ...
                                                $.ajax({
                                                    url: "/shopserver/api/Tools/CkEditorUploadFiles",
                                                    type: 'POST',
                                                    data: data,
                                                    dataType: 'json',
                                                    headers: {
                ...
                function () {
                    ...
                    cropperImg.cropImg({
                        ...
                        onCrop: function (data) {
                            ...
                            coreHelper.Post("shopserver/api/Tools/UploadFilesFByBase64", { base64: data }, function (res) {
                                if (0 === res.code) {

...
{
    [Injection(Order = 1)]
    public class IDefaultOrderService : OrderBaseService<Core.Entity.Order>, IDefaultOrderServices, ITransient
    {
        private Guid userId { get; set; }
        private readonly ICacheOperation _cache;
        public IDefaultOrderService(IRepository<Core.Entity.Order> _dal, ICacheOperation cache) : base(_dal)
        {
            _cache = cache;
        }

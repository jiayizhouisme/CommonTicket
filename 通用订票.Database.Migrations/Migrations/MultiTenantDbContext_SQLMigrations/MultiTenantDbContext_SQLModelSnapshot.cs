...
{
    [DbContext(typeof(MultiTenantDbContext_SQL))]
    partial class MultiTenantDbContext_SQLModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Furion.DatabaseAccessor.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConnectionString = "Data Source=localhost;Initial Catalog=Common;user id=admin;password=Aa123456;TrustServerCertificate=true;",

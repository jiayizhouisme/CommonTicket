...
namespace 通用订票.Database.Migrations.Migrations.MultiTenantDbContext_SQLMigrations
{
    /// <inheritdoc />
    public partial class v11 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("383afb88-f519-fff8-b364-6d563bf3687f"), "Data Source=localhost;Initial Catalog=Common;user id=admin;password=Aa123456;TrustServerCertificate=true;", new DateTimeOffset(new DateTime(2020, 10, 6, 20, 19, 7, 0, DateTimeKind.Unspecified), new TimeSpan(0, 8, 0, 0, 0)), null, "localhost:44313", "默认租户", null, null },

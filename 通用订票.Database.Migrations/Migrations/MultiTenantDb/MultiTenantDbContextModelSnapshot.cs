            ...
            modelBuilder.Entity("Furion.DatabaseAccessor.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConnectionString = "Data Source=localhost;Initial Catalog=CommonTicket;user id=admin;password=Aa123456;TrustServerCertificate=true;Max Pool Size=64; Min Pool Size=5",
                        ...
                        new
                        {
                            ...
                            ConnectionString = "Data Source=localhost;Initial Catalog=CommonTicket2;user id=admin;password=Aa123456;TrustServerCertificate=true;Max Pool Size=64; Min Pool Size=5",
            ...
            modelBuilder.Entity("通用订票.Core.Entity.JobCluster", b =>
                {
                    ...
                    b.ToTable("JobCluster", (string)null);
                });
            ...
            modelBuilder.Entity("通用订票.Core.Entity.JobTrigger", b =>
                {
                    ...
                    b.ToTable("JobTrigger", (string)null);
                });
